<template>
  <footer style="position: fixed;bottom: 0;width: 100%;">
    <section v-show="showNav">
      <nav style="width: 33%;float: left;text-align: center;cursor: pointer;" class="nav-movie">
        <router-link to="/home">
          <div class="nav-icon">
      ...
      <nav style="width: 33%;float: left;text-align: center;cursor: pointer;" class="nav-cinama">
      ...
      <nav style="width: 33%;float: left;text-align: center;cursor: pointer;" class="nav-me">
        <router-link to="/me">
          <div class="nav-icon">
