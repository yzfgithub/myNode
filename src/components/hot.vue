<template>
<section id="hot" style="width: 100%;">
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    mounted(){
      this.autoHeight=document.getElementById('hot').scrollWidth-95+'px';
        console.log(this.autoHeight,document.getElementById('hot').scrollWidth,document.getElementById('hot'))
    }
  }
</script>
